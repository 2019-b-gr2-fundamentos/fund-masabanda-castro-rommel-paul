...
function agregar() {
    return __awaiter(this, void 0, void 0, function () {
        var formatoDeDatos, formatoConvertido, contador, minimoID, arregloGases, datosGases, respuestasIngresar, nuevoRegistro, arregloFinal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    minimoID = minimoID + 1;
                    contador = minimoID;
                    arregloGases = formatoConvertido;
                    datosGases = [
                        {
                            type: 'text',
                            name: 'nombre',
                    ...
                    return [4 /*yield*/, prompts(datosGases)];
                case 1:
                    ...
                    arregloFinal = JSON.stringify(arregloGases);
